...
class GHZMineViewController: JWBaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func setupNaviegationBar() {
        self.jwSetRightBarItemImage(UIImage(named: "message_icon"))
        self.jwSetNavigationBar(title: "个人中心")
    }
